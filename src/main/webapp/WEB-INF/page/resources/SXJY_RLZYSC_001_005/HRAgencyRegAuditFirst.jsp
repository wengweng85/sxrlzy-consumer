...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
			    <table id="ef11table" data-url="<c:url value='/resources/SXJY_RLZYSC_001_005/getEf11List?flag=1'/>" 
    ...
    function hragency_reg_bataudit(){
		...
		layer.confirm('确定要批量审核所选数据吗？',function(index){
		   rc.ajax("<c:url value='/resources/SXJY_RLZYSC_001_005/bataudit?flag=1'/>", {selectnodes:selectnodes},function (response) {
    ...
    function hragency_reg_singleaudit(aab998,eae052){
		...
		layer.confirm('确定要审核该条记录吗？',function(index){
		   rc.ajax("<c:url value='/resources/SXJY_RLZYSC_001_005/singleaudit?flag=1'/>", {aab998:aab998},function (response) {
		    	alert(response.message);
		    	$('#ef11table').refreshtable();
		   }); 
	    }); 
    ...
    function hragency_reg_notauditpass(aab998,eae052){
    	...
    	layer.open({
	   		  ...
	   		  shade: 0.8,
	   		  area: ['70%', '60%'],
	   		  content: "<c:url value='/resources/SXJY_RLZYSC_001_005/notauditpass/1'/>/"+aab998//iframe的url
		  });  
    }
    </script>
</body>
