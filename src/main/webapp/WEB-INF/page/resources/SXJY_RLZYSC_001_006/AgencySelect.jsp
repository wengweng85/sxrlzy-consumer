...
<body class="gray-bg">
    <div class="wrapper">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
			    <table id="ef11querytable" data-url="<c:url value='/resources/SXJY_RLZYSC_001_006/getEf11List'/>" 
			    data-pagination="true"  data-page-size="10">
			    <thead>
				    <tr>
				        <th data-formatter="select_indexFormatter">序号</th>
	                    <th data-field="aef101" >机构编号</th>
	                    <th data-field="aef104" >机构名称</th>
	                    <th data-field="aab998" >统一社会信用代码</th>
	                    <th data-field="aef105" >机构状态</th>
	                    <th data-field="aef106" >机构性质</th>
	                    <th data-field="aef115" >机构电话号码</th>
				    </tr>
			    </thead>
			    </table>
            </div>
