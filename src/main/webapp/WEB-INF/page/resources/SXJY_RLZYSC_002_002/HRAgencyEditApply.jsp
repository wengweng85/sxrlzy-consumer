...
<div class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <form action="${contextpath}/resources/SXJY_RLZYSC_002_002/editData">
	            ...
	            <div class="ibox-content">
		            <div class="form-horizontal"  >
				        <div class="form-group">
			               ...
			               <rc:textedit  property="aef104" required="true" label="机构名称" readonly="true" cols="2,5" validate="{required:true,maxlength:100,messages:{required:'机构名称不能为空'}}"  />
			               <rc:textedit  property="aab998" required="true"  label="统一社会信用代码" readonly="true" cols="2,3" validate="{required:true,maxlength:18,messages:{required:'统一社会信息用代码不能为空'}}"/>
			           </div>
				       ...
				       <div class="hr-line-dashed"></div>
				       <div class="form-group">
				           <rc:textedit property="aef108" required="true"  label="注册机关" cols="2,2" validate="{required:true,maxlength:20}" />
				           <rc:select property="aef107" required="true"  readonly="true"  label="隶属关系所在市"  cols="2,2" onchange="rc.code_value_select_data_change(this.value,'AAB802',['#aef134'])"     codetype="AAB801" validate="{required:true,messages:{required:'隶属关系所在市不能为空'}}"/>
			               <rc:select property="aef134" required="true"  readonly="true"  label="隶属关系所在区县"  cols="2,2"  codetype="AAB802"  validate="{required:true,messages:{required:'隶属关系所在区县不能为空'}}"/>
				       </div>
				       <div class="hr-line-dashed"></div>
				       <div class="form-group">
	            ...
	            <div class="ibox-content">
		            <div class="form-horizontal"  >
				        <div class="form-group">
			               ...
			               <rc:textedit  property="aef122" required="true"  label="机构联系人电话" cols="2,2" validate="{mobile:true,required:true,messages:{required:'请输入机构联系人电话'},maxlength:20}"/>
