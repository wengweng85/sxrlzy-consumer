...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
	            ...
	            <form class="form-horizontal" id="query_form" >
	              <div id="input_content">
			        <div class="form-group">
				        ...
				        <div class="form-group">			            
				        <rc:textedit property="aee124" label="数据所属期" cols="2,2" />	
			            <div align="right">     
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
			    <table id="ee15table" data-url="<c:url value='/resources/SXJY_RLZYSC_004_002/getrecruitdata'/>" 
    ...
    $(function(){
    	//$('.collapse-link').click();
    	$('#ee15table').inittable(demo_options);
    });
    ...
    //用户表格监听,双击 
    $('#ee15table').on('dbl-click-row.bs.table', function (e, row, $element) {
    ...
    function demo_view_by_id(eee151){
    	layer.open({
	   		...
	   		maxmin:true,
	   		  shade: 0.8,
	   		  area: ['80%', '60%'],
	   		  content: "<c:url value='/resources/SXJY_RLZYSC_004_002/viewRecruitdata'/>/"+eee151+"/"+aab998 //iframe的url
 		});
    }
