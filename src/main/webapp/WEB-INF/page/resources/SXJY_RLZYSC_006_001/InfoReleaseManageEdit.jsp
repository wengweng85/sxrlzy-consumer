...
<div class="navbar navbar-inverse navbar-fixed-top">
	            ...
	            <div class="ibox-content">
		            <div class="form-horizontal"  >
				        <div class="form-group">
				           <rc:hidden property="eee141" value="${ee14.eee141}" />
			               <rc:textedit  property="aee119" required="true" label="信息标题"  value="${ee14.aee119}" cols="2,4"   validate="{required:true,maxlength:200,messages:{required:'信息标题不能为空'}}"/>
			               <rc:select  property="aee118" required="true" label="信息发布类型" value="${ee14.aee118}"  codetype="AEE118" cols="2,3" validate="{required:true,messages:{required:'请选择信息发布类型'}}"  />
			           </div>
			           <div class="hr-line-dashed"></div>
			           <div class="form-group">
				           <rc:select property="aee121" required="true"  label="是否上传附件"  cols="2,2" value="${ee14.aee121}"  codetype="YESNO" onchange="isUploadFile(this)"  validate="{required:true,messages:{required:'请选择是否上传附件'}}"/>
				       ...
				       <div id ="fujian" style="display:none">
				          <div class="ibox-title">
				                <h5>公告附件信息</h5>
				                <div class="form-group" style="text-align: right;">
				                    <button id="btn_delete" type="button" class="btn btn-small btn-danger" onclick="demo_delete_file()">
			           ...
			           <div class="hr-line-dashed"></div>
			           <rc:textarea label="信息发布内容" property="aee120"   required="true" rows="8" value="${ee14.aee120}"   validate="{required:true,maxlength:2000,messages:{required:'信息发布内容不能为空'}}"/>
			       </div>
		       </div>
	        </div>
	        <!-- 信息发布结束 -->
    ...
    $(function() {
    	var eee141 = $('#eee141').val();
    	var aee121 = $('#aee121').val();
    	//验证 ajax
    	...
    	var url="<c:url value='/common/fileload/getFileList'/>?file_bus_id="+eee141;
