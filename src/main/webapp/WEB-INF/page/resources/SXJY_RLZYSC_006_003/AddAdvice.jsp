...
<div class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="wrapper wrapper-content ">
         <form action="${contextpath}/resources/SXJY_RLZYSC_006_003/saveEe17data" >
		            ...
		            <div class="form-horizontal"  >
			            <div class="hr-line-dashed"></div>
			             <div class="form-group">
			                ...
			                <rc:textedit  property="aee150" required="true"  label="意见标题" cols="2,6" validate="{required:true,messages:{required:'标题信息不能为空'}}"/>
			            </div>		             			            
			            <div class="hr-line-dashed"></div>
					    <rc:textarea label="意见内容" property="aee151"   required="true" rows="6"   validate="{required:true,messages:{required:'内容信息不能为空'}}"/>					  					    
			       </div>
		       </div>
	        </div>	        
