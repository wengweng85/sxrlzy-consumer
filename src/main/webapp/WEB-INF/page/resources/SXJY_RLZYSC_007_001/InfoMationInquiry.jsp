...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
         ...
         <div class="ibox float-e-margins">
            ...
            <form class="form-horizontal" id="query_form" > 	                
			        <div class="form-group" >      
			            ...
			            <div class="form-group">
						<rc:select property="a_aef109"  label="经营类型"
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
			    <table id="ef11table" data-url="<c:url value='/resources/SXJY_RLZYSC_007_001/getEf11List'/>" 
    ...
    function demo_view_by_id(aef101){
    	layer.open({
	   		...
	   		maxmin:true,
	   		  shade: 0.8,
	   		  area: ['70%', '90%'],
	   		  content: "<c:url value='/resources/SXJY_RLZYSC_007_001/viewInfomation'/>/"+aef101+"/"+aab998 //iframe的url
 		});
    }
